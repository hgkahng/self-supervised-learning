...
class WarmupCosineSchedule(LambdaLR):
    ...
    """
    def __init__(self, optimizer, warmup_steps, t_total, cycles=.5, min_lr=0., last_epoch=-1):
...
def get_cosine_scheduler(optimizer: optim.Optimizer, epochs: int, warmup_steps: int = 0):
