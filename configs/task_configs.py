...
class CLAPPConfig(PretrainConfigBase):
    ...
    def task_specific_parser():
        ...
        parser.add_argument('--projector_dim', type=int, default=128, help='Dimension of projection head.')
        parser.add_argument('--num_negatives', type=int, default=65536, help='Number of negative examples to maintain.')
        parser.add_argument('--temperature', type=float, default=0.1, help='Logit scaling factor.')
        ...
        parser.add_argument('--query_augment', type=str, default='randaugment', help='Augmentation applied to query (x_q).')
        ...
        parser.add_argument('--normalize', type=str, default='sparsemax', help='Method for normalizing logits to distribution.')
